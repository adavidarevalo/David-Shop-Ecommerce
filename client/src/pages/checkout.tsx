...
import CheckoutOrderSummary from '../components/checkout_order_summary'
...
export default function CheckoutPage() {
    ...
    return (
      <Box minH={"90vh"} maxW={{base: "3xl", lg: "7xl"}} mx={"auto"} px={{base: 4, md: 8, lg: 12}} py={{base: 6, md: 8, lg: 12}}>
